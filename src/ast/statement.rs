...
#[derive(Debug, Clone)]
pub struct FunctionData { pub name: Identifier, pub type_params: Vec<(Identifier, Type)>, pub params: Vec<Identifier>, pub types: Vec<Option<Type>>, pub returns: Option<Type>, pub body: Block }
#[derive(Debug, Clone)]
...
#[derive(Debug, Clone)]
pub struct AliasData { pub alias: Identifier, pub type_params: Vec<(Identifier, Type)>, pub typ: Type }
